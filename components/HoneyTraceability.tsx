        ...
        {activeTab === 'POS' && (
            <div className="flex flex-col md:flex-row gap-6 h-full relative">
                ...
                <button 
                    ...
                    className="md:hidden fixed bottom-24 right-4 bg-amber-600 text-white p-4 rounded-full shadow-2xl z-30 flex items-center gap-2 animate-bounce-short"
                >
                ...
                >
                    <div className="p-4 bg-gray-50 border-b flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative w-14 h-14 flex items-center justify-center transition-transform hover:scale-105" title="Nombre d'articles">
